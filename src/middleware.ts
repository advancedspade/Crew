...
export default withAuth(
  function middleware(req) {
    ...
    // Admin-only routes (recruiting pipeline + onboarding + FAQ admin + team tracker)
    const adminOnlyPaths = ['/recruiting', '/api/recruiting', '/onboarding', '/api/onboarding', '/faq/admin', '/api/faq/admin', '/team/tracker', '/api/team/tracker', '/team/alumni'];
